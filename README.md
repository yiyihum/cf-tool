...
[![Github release](https://img.shields.io/github/release/yiyihum/cf-tool.svg)](https://github.com/yiyihum/cf-tool/releases)
[![platform](https://img.shields.io/badge/platform-Windows%20%7C%20macOS%20%7C%20Linux-blue.svg)](https://github.com/yiyihum/cf-tool/releases)
[![Build Status](https://travis-ci.org/yiyihum/cf-tool.svg?branch=master)](https://travis-ci.org/yiyihum/cf-tool)
[![Go Report Card](https://goreportcard.com/badge/github.com/yiyihum/cf-tool)](https://goreportcard.com/report/github.com/yiyihum/cf-tool)
[![Go Version](https://img.shields.io/badge/go-%3E%3D1.12-green.svg)](https://github.com/golang)
[![license](https://img.shields.io/badge/license-MIT-%23373737.svg)](https://raw.githubusercontent.com/yiyihum/cf-tool/master/LICENSE)
...
You can download the pre-compiled binary file in [here](https://github.com/yiyihum/cf-tool/releases).
...
```plain
$ go get github.com/yiyihum/cf-tool
$ cd $GOPATH/src/github.com/yiyihum/cf-tool
...
Examples:
  ...
  cf pull              Pull the latest codes of current problem into current
                       path.
  cf clone yiyihum      Clone all codes of yiyihum.
...
Script in template:
  ...
  $%path%$   Path to source file (Excluding $%full%$, e.g. "/home/yiyihum/")
 ...
 * You can download the binary file in here https://github.com/yiyihum/cf-tool (Windows, macOS, Linux)
 * Author: $%U%$
 * Time: $%Y%$-$%M%$-$%D%$ $%h%$:$%m%$:$%s%$
**/
